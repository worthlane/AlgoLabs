...
int Median(int* array, int a, int b, int c)
{
    assert(array);
...
int PivotsPartition(int* array, int l, int r, int take_pivot(int*, int, int))
{
...
void PivotsQSort(int* array, const size_t left, const size_t right, int take_pivot(int*, int, int))
{
	assert(array);
...
int CentralPivot(int* array, int l, int r)
{
    assert(array);
...
int MedianThreePivot(int* array, int l, int r)
{
    assert(array);
...
int RandPivot(int* array, int l, int r)
{
    assert(array);
...
int RandMedianPivot(int* array, int l, int r)
{
    assert(array);
