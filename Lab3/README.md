...
Можно заметить, что в среднем, сортировка выполняется дольше с ростом кратности кучи. Это будет более видно если мы оставим только зависимости для трех кратностей (минимальную, среднюю и максимальную)
...
![](imgs/4_tests_most_dublicates.png)
...
![](imgs/5_big_tests.png)

По графику заметно, что все стратегии выборы, кроме медианы трех случайных, работают примерно с одной скоростью. Но все же, стратегию выбора центрального элемента pivot'ом, можем считать самой быстрой из всех.
